...
return closeinvo;
    ...
    @FindBy(xpath = "//select[@id='setting_superbill_appointment']")
...
////Billing and Services
    ...
    @FindBy(xpath = "(//option[@id='setting_billing_option'])[1]")
    ...
    @FindBy(xpath = "//button[@id='setting_billing_btn']")
    ...
    @FindBy(xpath = "//button[@id='setting_billing_savebtn']")
    ...
    @FindBy(xpath = "//button[@id='setting_addservice_btn']")
    ...
    @FindBy(xpath = "//button[@id='setting_newpayer_btn']")
    ...
    @FindBy(xpath = "//input[@id='setting_payercity']")
    ...
    @FindBy(xpath = "//select[@id='setting_payerstate']")
    ...
    @FindBy(xpath = "//input[@id='setting_payer_zip']")
    ...
    @FindBy(xpath = "//button[@id='setting_payer_closebtn']")
    private WebElement Clickclose;
    ...
    @FindBy(xpath = "//button[@id='setting_payer_savebtn']")
    private WebElement ClickSAVEButton;
    ...
    @FindBy(xpath = "//a[@id='setting_nav_lab']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_organisation']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_phone']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_mobile']")
    private WebElement EnterMobile;

    public WebElement getEnterMobile(){
	return EnterMobile;
   }  
    @FindBy(xpath = "//div[@class='ant-tabs-content-holder']//div[2]//div[1]//input[1]")
    ...
    @FindBy(xpath = "//div[contains(@class,'ant-tabs-content-holder')]//div[2]//div[1]//input[1]")
    ...
    @FindBy(xpath = "//button[@id='setting_lab_closebtn']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_active']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_name']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_facility']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_receiver']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_receiver_facility']")
    ...
    @FindBy(xpath = "//select[@id='setting_lab_protocol']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_login']")
    private WebElement EnterLoginID;

    public WebElement getEnterLoginID(){
	return EnterLoginID;
    }
    @FindBy(xpath = "//input[@id='setting_lab_remote']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_result']")
    ...
    @FindBy(xpath = "//input[@id='setting_lab_order']")
    ...
    @FindBy(xpath = "//button[@id='setting_lab_savebtn']")
...
@FindBy(xpath = "//div[@id='setting_nav_scheduling']")
...
@FindBy(xpath = "//a[@id='setting_nav_calendersetting']")
...
@FindBy(xpath = "//select[@id='setting_calendar_from']")
...
@FindBy(xpath = "//select[@id='setting_calendar_to']")
...
@FindBy(xpath = "//select[@id='setting_calenderview']")
...
@FindBy(xpath = "(//option[@id='setting_calender_week_option'])[1]")
...
@FindBy(xpath = "//a[@id='setting_nav_reminder']")
...
@FindBy(xpath = "//button[@id='setting_email_switch']")
...
@FindBy(xpath = "//select[@id='setting_email_clinician']")
...
@FindBy(xpath = "//option[@value=' {Clinician Full Name}']")
...
@FindBy(xpath = "//select[@id='setting_email_client']")
...
@FindBy(xpath = "//select[@id='setting_email_appointment']")
...
@FindBy(xpath = "//select[@id='setting_email_link']")
...
@FindBy(xpath = "//button[@id='setting_email_closebtn']")
...
@FindBy(xpath = "//button[@id='setting_tele_editbtn']")
...
@FindBy(xpath = "//select[@id='setting_tele_clinician']")
...
@FindBy(xpath = "//select[@id='setting_tele_practice']")
...
@FindBy(xpath = "//select[@id='setting_tele_client']")
...
@FindBy(xpath = "//select[@id='setting_tele_appointment']")
...
@FindBy(xpath = "//select[@id='setting_tele_link']")
...
@FindBy(xpath = "//button[@id='setting_tele_cancelbtn']")
...
@FindBy(xpath = "//select[@id='setting_voice_clinician']")
...
@FindBy(xpath = "//select[@id='setting_voice_practice']")
...
@FindBy(xpath = "//select[@id='setting_voice_client']")
...
@FindBy(xpath = "//select[@id='setting_voice_appointment']")
...
@FindBy(xpath = "//select[@id='setting_voice_link']")
...
@FindBy(xpath = "//button[@id='setting_voice_closebtn']")
...
//////////////////// text //////////
@FindBy(xpath = "//div[@id='setting_reminder_tabs-tab-3']")
...
@FindBy(xpath = "//button[@id='setting_text_switch']")
...
@FindBy(xpath = "//button[@id='setting_text_editbtn']")
...
@FindBy(xpath = "//select[@id='setting_text_clinician']")
...
@FindBy(xpath = "//select[@id='setting_text_practice']")
...
@FindBy(xpath = "//select[@id='setting_text_client']")
...
@FindBy(xpath = "//select[@id='setting_text_appointment']")
...
@FindBy(xpath = "//select[@id='setting_text_link']")
...
@FindBy(xpath = "//button[@id='setting_text_closebtn']")
...
@FindBy(xpath = "(//li[@class='sc-grVGCS sc-afnQL dUWpJb kxHCPR'])[4]")
...
@FindBy(xpath = "(//li[@class='sc-grVGCS sc-afnQL dUWpJb kxHCPR'])[5]")
...
@FindBy(xpath = "(//option[@value='{Practice Client Portal Login Link}'])[1]")
...
@FindBy(xpath = "//button[normalize-space()='Save']")
private WebElement ClickPatientSave;

public WebElement getClickPatientSave() {

	return ClickPatientSave;
}
@FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]")
